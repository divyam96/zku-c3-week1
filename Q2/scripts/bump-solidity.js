...
let content3 = fs.readFileSync("./contracts/plonk_Multiplier3Verifier.sol", { encoding: 'utf-8' });
let bumped3 = content3.replace(solidityRegex, 'pragma solidity ^0.8.0');
bumped3 = bumped3.replace(verifierRegex, 'contract plonk_Multiplier3Verifier');

fs.writeFileSync("./contracts/plonk_Multiplier3Verifier.sol", bumped3);
